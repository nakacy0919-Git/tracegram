...
import { subjPrepCategory } from './categories/subj_prep';
...
import { verbTransitiveCategory } from './categories/verb_transitive';
...
import { objSvooCategory } from './categories/obj_svoo';
...
import { compSvcCategory } from './categories/comp_svc';
...
import { modAdjCategory } from './categories/mod_adj';
...
export const PROBLEM_SETS = [
  ...
  // 🟢 1. SUBJECT (主語) マスター
  { categoryId: 'subj_prep', title: 'Sub-1: 前置詞句の修飾', description: 'The boys in the park... のようにMを伴う主語', problems: subjPrepCategory.problems },
  ...
  // 🟠 2. VERB (動詞) マスター
  { categoryId: 'verb_transitive', title: 'Sub-1: 自動詞と他動詞', description: '目的語をとるかどうかの見極め', problems: verbTransitiveCategory.problems },
  ...
  // 🔵 3. OBJECT (目的語) マスター
  { categoryId: 'obj_svoo', title: 'Sub-1: 第4文型 (O1 / O2)', description: '「誰に(O1)」「何を(O2)」を正確に分ける', problems: objSvooCategory.problems },
  ...
  { categoryId: 'comp_svc', title: 'Sub-1: 第2文型 (SVC)', description: '主語の状態・変化を表す形容詞・名詞', problems: compSvcCategory.problems },
  ...
  // 🟡 5. MODIFIER (修飾語) マスター
  { categoryId: 'mod_adj', title: 'Sub-1: 形容詞のカタマリ', description: '名詞を修飾する分詞・関係詞・同格のthat', problems: modAdjCategory.problems },
