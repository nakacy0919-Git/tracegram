...
import { basicRemoveMCategory } from './categories/basic_remove_m.js';
import { basic5patternsCategory } from './categories/basic_5patterns';
import { subjectCategory } from './categories/subject'; // subj_prep
...
import { verbCategory } from './categories/verb'; // verb_transitive
...
import { objectCategory } from './categories/object'; // obj_svoo
...
import { complementCategory } from './categories/complement'; // comp_svc
...
import { participleCategory } from './categories/participle'; // mod_adj
...
export const PROBLEM_SETS = [
  ...
  { categoryId: 'subj_clause', title: 'Sub-3: 名詞節の主語', description: 'That he is alive / What I need... などの節', problems: [] },
  { categoryId: 'subj_it', title: 'Sub-4: 形式主語 (it)', description: 'It is true that... / It is hard to... などの構文', problems: [] },
  { categoryId: 'subj_inversion', title: 'Sub-5: 倒置・無生物主語', description: '文頭のMに惑わされず、後ろに隠れたSを見つける特訓', problems: [] },

  // ==========================================
  // 🟠 2. VERB (動詞) マスター
  // ==========================================
  { categoryId: 'verb_transitive', title: 'Sub-1: 自動詞と他動詞', description: '目的語をとるかどうかの見極め', problems: verbCategory.problems },
  { categoryId: 'verb_tense', title: 'Sub-2: 時制と相のカタマリ', description: 'have been studying のように複数語で1つのVとなるもの', problems: [] },
  { categoryId: 'verb_passive', title: 'Sub-3: 受動態のカタマリ', description: 'is known to / has been made などの受動態', problems: [] },
  { categoryId: 'verb_phrasal', title: 'Sub-4: 助動詞と群動詞', description: '句動詞 look forward to などを1つのVとしてなぞる', problems: [] },

  // ==========================================
  // 🔵 3. OBJECT (目的語) マスター
  // ==========================================
  { categoryId: 'obj_svoo', title: 'Sub-1: 第4文型 (O1 / O2)', description: '「誰に(O1)」「何を(O2)」を正確に分ける', problems: objectCategory.problems },
  { categoryId: 'obj_verbal', title: 'Sub-2: 準動詞の目的語', description: '動詞の後に続く to do や ~ing のカタマリ', problems: [] },
  { categoryId: 'obj_clause', title: 'Sub-3: 名詞節の目的語', description: 'that節 や 疑問詞節のカタマリ', problems: [] },
  { categoryId: 'obj_it', title: 'Sub-4: 形式目的語 (it)', description: 'find it easy to do のように、後ろの真目的語とリンクさせる', problems: [] },
  ...
  { categoryId: 'comp_svoc', title: 'Sub-2: 第5文型 (SVOC)', description: '目的語の役職や状態を表す名詞・形容詞', problems: [] },
  { categoryId: 'comp_causative', title: 'Sub-3: 知覚・使役動詞の補語', description: 'Oの後にくる 原形不定詞 や 分詞(ing/ed)', problems: [] },
  { categoryId: 'comp_clause', title: 'Sub-4: 補語になる節・句', description: 'The problem is that... / My dream is to...', problems: [] },

  // ==========================================
  // 🟡 5. MODIFIER (修飾語) マスター
  // ==========================================
  { categoryId: 'mod_adj', title: 'Sub-1: 形容詞のカタマリ', description: '名詞を修飾する分詞・関係詞・同格のthat', problems: participleCategory.problems },
  { categoryId: 'mod_adv', title: 'Sub-2: 副詞のカタマリ', description: '動詞・文全体を修飾する前置詞句や副詞節', problems: [] }, // patternの読み込みを削除
  { categoryId: 'mod_participle', title: 'Sub-3: 分詞構文', description: 'Seeing the police... のように現れる副詞句', problems: [] },
];